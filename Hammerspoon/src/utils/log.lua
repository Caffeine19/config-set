...
function log.createLogger(moduleName)
	...
	logger.success = function(...)
		log.success(moduleName, ...)
	end

	logger.start = function(...)
		log.start(moduleName, ...)
	end
	logger.launch = function(...)
		log.launch(moduleName, ...)
	end
	logger.wait = function(...)
		log.wait(moduleName, ...)
	end
	logger.search = function(...)
		log.search(moduleName, ...)
	end
	logger.click = function(...)
		log.click(moduleName, ...)
	end
	logger.type = function(...)
		log.type(moduleName, ...)
	end
	logger.link = function(...)
		log.link(moduleName, ...)
	end
	logger.target = function(...)
		log.target(moduleName, ...)
	end
	logger.celebrate = function(...)
		log.celebrate(moduleName, ...)
	end
	logger.button = function(...)
		log.button(moduleName, ...)
	end
	logger.image = function(...)
		log.image(moduleName, ...)
	end
	logger.quit = function(...)
		log.quit(moduleName, ...)
	end

	logger.custom = function(emoji, ...)
		log.custom(emoji, moduleName, ...)
	end
