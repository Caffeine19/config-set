...
function toggleEdgeTabsPane.collapse()
	...
	local collapseButton =
		find.byDescriptionAndRole(axApp, "Collapse pane", "AXPopUpButton")
...
function toggleEdgeTabsPane.pin_async()
	return async(function()
		...
		local tabActionsMenu = find.byDescriptionAndRole(
			axApp,
			"Tab Actions Menu",
			"AXPopUpButton"
		)
		...
		logger.debug(
			"Hovering over Tab Actions Menu at position:",
			centerX,
			",",
			centerY
		)
		...
		local pinPaneButton =
			find.byDescriptionAndRole(axApp, "Pin pane", "AXPopUpButton")
